...
*/
class Wpw_Fp_Message_Stack {
  
    var $messageToStack, $messages;

	// class constructor
    function Wpw_Fp_Message_Stack() {
		...
		if( !isset( $_SESSION['wpwfp_message_stack'] ) ) {
			$_SESSION['wpwfp_message_stack'] = array( 'messageToStack' => array() );
		}
		
		$this->messageToStack =& $_SESSION['wpwfp_message_stack']['messageToStack'];
