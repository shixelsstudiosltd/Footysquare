...
class CHIMP_MC_Plugin {
	...
	private static $textdomain = 'Statfort';
	...
	public function get_admin_notices () {
		...
		$notice .= __('You\'ll need to set up the MailChimp signup widget plugin options before using it. ', 'Kings Club') . __('You can make your changes', 'Kings Club') . ' <a href="' . get_admin_url() . 'themes.php?page=px_theme_options#tab-api-key-show">' . __('here', 'Kings Club') . '.</a>';
	...
	private function get_api_key () {
		...
		if (! empty($px_theme_option['mailchimp_key'])) {

			return $px_theme_option['mailchimp_key'];
