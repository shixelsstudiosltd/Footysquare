...
<div class="wprc-container <?php echo $form_options['color_scheme']; ?>">
	...
	<a href="#flag-form-<?php echo $post->ID; ?>" class="fancybox"><i class="fa fa-flag"></i><?php //echo $form_options['slidedown_button_text']; ?></a>
	<div id="flag-form-<?php echo $post->ID; ?>" class="wprc-content">
