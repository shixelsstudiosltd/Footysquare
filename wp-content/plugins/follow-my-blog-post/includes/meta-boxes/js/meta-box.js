...
function wpsUpdateRepeaterFields(){
     ...
     * @since 1.0
     */
    jQuery('.wps-meta-date').each( function() {
    ...
    jQuery('.wps-meta-datetime').each( function() {
     ...
     * @since 1.0
     */
    jQuery('.wps-meta-time').each( function() {
     ...
     * @since 1.0
     */
    jQuery( document ).on( "click", ".wps-meta-color-select", function() {
      var jQuerythis = jQuery(this);
      var id = jQuerythis.attr('rel');
      jQuery(this).siblings('.wps-meta-color-picker').farbtastic("#" + id).toggle();
      return false;
    });
     ...
     * @since 1.0
     */
    jQuery( document ).on( "click", ".wps-meta-add-file", function() {
      var jQueryfirst = jQuery(this).parent().find('.file-input:first');
      jQueryfirst.clone().insertAfter(jQueryfirst).show();
      return false;
    });
    
    jQuery( document ).on( "click", ".wps-meta-add-fileadvanced", function() {
     ...
     * @since 1.0
     */
    jQuery( document ).on( "click", ".wps-meta-upload .wps-meta-delete-file", function() {
     ...
     * @since 1.0
     */
    jQuery('.wps-meta-images').each( function() {
      ...
      jQuerythis.sortable( {
        ...
        update: function (){
          ...
          data   = order + '|' + jQuerythis.siblings('.wps-meta-images-data').val();
     ...
     * @since 1.0
     */
    jQuery( document ).on( "click", ".wps-meta-upload-button", function() {
      ...
      window.send_to_editor = function(html) {
        ...
        jQuery('#wps-meta-images-' + field_id).append( jQuery(html) );
...
jQuery(document).ready(function(jQuery) {
   ...
   */
  //edit
  jQuery( document ).on( "click", ".wps-meta-re-toggle", function() {
  ...
  if (jQuery.farbtastic){//since WordPress 3.5
  	jQuery( document ).on( "focus", ".wps-meta-color", function() {
      load_colorPicker(jQuery(this).next());
    });

    jQuery( document ).on( "focusout", ".wps-meta-color", function() {
    ...
    //issue #15
    jQuery('.wps-meta-color').each(function(){
  ...
  */
  jQuery( document ).on( "click", ".wps-meta-add-fileadvanced", function() {
     ...
     jQueryfirst.clone().insertAfter(jQueryfirst).show();
     jQuery(this).parent().find('.file-input-advanced:last .wps-upload-file-link').val('');
     return false;
   });
   ...
   * Advanced Add Files
   */
  jQuery( document ).on( "click", ".wps-delete-fileadvanced", function() {
   ...
   jQuery( document ).on( "click", ".wps-upload-fileadvanced", function(e) {

		e.preventDefault();
		
		if(typeof wp == "undefined" || WpsMeta.new_media_ui != '1' ){// check for media uploader
			...
			tb_show('', 'media-upload.php?post_id='+ jQuery('#post_ID').val() + '&type=image&amp;TB_iframe=true');
		      ...
		      window.send_to_editor = function(html) {
		        ...
		        window.formfield.find('.wps-upload-file-link').val(attachmenturl);
	        
		        wpsLoadImagesMuploader();
		        tb_remove();
			...
			file_frame.on( 'insert', function() {
				...
				selection.each( function( attachment, index ) {
					...
					if(index == 0){
						...
						window.formfield.find('.wps-upload-file-link').val(attachment_url);
  ...
  function wpsLoadImagesMuploader(){
    jQuery(".mupload_img_holder").each(function(i,v){
      if (jQuery(this).next().next().val() != ''){
        if (!jQuery(this).children().size() > 0){
          ...
          jQuery(this).next().next().next().removeClass('wps-meta-upload_image_button').addClass('wps-meta-delete_image_button');
        }
      }
    });
  }
  ...
  jQuery( document ).on( "click", ".wps-meta-delete_image_button", function(e) {
  	jQuery(this).prev().val('');
  	jQuery(this).prev().prev().val('');
  	jQuery(this).prev().prev().prev().html('');
  	jQuery(this).val("Upload Image");
    jQuery(this).removeClass('wps-meta-delete_image_button').addClass('wps-meta-upload_image_button');
  });
  ...
  // WP 3.5+ uploader
    ...
    jQuery( document ).on( "click", ".wps-meta-upload_image_button", function(e) {
 ...
 * @since 2.9.8
 */
function wpsFancySelect(){
  jQuery(".wps-metabox-wrapper select").each(function (){
